...
API_URL = "https://langgraph-chatbot-e2fw.onrender.com/chat"

if st.button("Ask Agent!"):
    if user_query.strip():   # if user clicks the button without entering a query, we can show an error message
